    ...
    return (
        <div>
            {loading ? (
                ...
                <>
                    <h1 className="text-lg text-black text-left font-semibold !my-4">
                        Admin Dashboard
                    </h1>
                    <div className="mt-10">
                            ...
                            <div className="p-6 border-2 border-blue-300 bg-blue-100 rounded-md">
                                <p className="text-2xl">
                                    {new Intl.NumberFormat().format(
                                        summary.ordersPriceTotal
                                    )}
                                    <span className="text-lg text-gray-600 italic inline-block !ml-3">
                                        VNĐ
                                    </span>
                                </p>
                                ...
                                <Link href="/admin/orders">
                                    <a className="font-semibold !underline underline-offset-4 !decoration-2 !text-blue-600">
                                        View Sales
                                    </a>
                                </Link>
                            </div>
