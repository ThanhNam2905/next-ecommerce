...
export default function PlaceOrderPage() {
    ...
    const handlerPlaceOrder = async () => {
        try {
            ...
            router.push(`/order-detail/${data._id}`)
    ...
    return (
        <div className='mt-6 mb-16'>
            ...
            <h2 className='!py-3 text-[20px]'>Chi tiết đơn hàng của bạn</h2>
            {
                cartItems.length === 0 ? (
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-12 md:gap-8'>
                        ...
                        <div className='col-span-4'>
                            <div className='px-6 pt-5 pb-6 border rounded-md shadow-md min-h-fit'>
                                <h4 className='font-semibold !mb-2.5 text-[18px]'>Xác nhận thanh toán</h4>
